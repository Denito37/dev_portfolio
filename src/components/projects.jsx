...
export default function Projects({ entry }){
    return(
        <section className=" text-center bg-zinc-950 md:text-left p-4 m-4 max-w-6xl border rounded-2xl md:grid md:grid-cols-6 gap-4 justify-items-center items-center">
            <div>
                <h3 className=" p-2 md:p-0 text-3xl font-extralight">
                    {entry.title}
                </h3>
                <p className=" text-sm font-extralight p-2 md:p-0">
                    {entry.stack}
                </p>
            </div>
